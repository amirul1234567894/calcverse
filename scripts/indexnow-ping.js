...
// All real URLs from sitemap.xml (29 URLs)
const URLS = [
  `${SITE_URL}/`,
  `${SITE_URL}/blog`,
  `${SITE_URL}/contact`,
  `${SITE_URL}/privacy`,
  `${SITE_URL}/terms`,
  `${SITE_URL}/calculators/emi`,
  `${SITE_URL}/calculators/bmi`,
  `${SITE_URL}/calculators/loan`,
  `${SITE_URL}/calculators/mortgage`,
  `${SITE_URL}/calculators/interest`,
  `${SITE_URL}/calculators/income-tax`,
  `${SITE_URL}/calculators/sales-tax`,
  `${SITE_URL}/calculators/percentage`,
  `${SITE_URL}/calculators/bmr`,
  `${SITE_URL}/calculators/pregnancy`,
  `${SITE_URL}/calculators/due-date`,
  `${SITE_URL}/calculators/conception`,
  `${SITE_URL}/calculators/basic`,
  `${SITE_URL}/calculators/scientific`,
  `${SITE_URL}/calculators/age`,
  `${SITE_URL}/calculators/time`,
  `${SITE_URL}/calculators/gpa`,
  `${SITE_URL}/calculators/grade`,
  `${SITE_URL}/calculators/unit-conversion`,
  `${SITE_URL}/calculators/subnet`,
  `${SITE_URL}/calculators/concrete`,
  `${SITE_URL}/blog/how-to-calculate-bmi-correctly`,
  `${SITE_URL}/blog/emi-calculator-explained`,
  `${SITE_URL}/blog/age-calculator-by-date-of-birth`,
];
...
async function main() {
  ...
  const healthEmoji = health.down === 0 ? 'OK' : 'WARN';
  const bingEmoji = bing.ok ? 'OK' : 'FAIL';
  const yandexEmoji = yandex.ok ? 'OK' : 'FAIL';
